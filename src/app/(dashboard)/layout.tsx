    ...
    return (
        <div className=' w-full flex h-screen' >
            ...
            <div className=' hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5
                overflow-y-auto border-r  border-gray-200 p-6 bg-white'>
                <Link href='/dashboard' className=' flex h-16 shrink-0 items-center '>
                    <Icons.Logo className='h-20  text-indigo-600'/>
                </Link>
            ...
            <aside className='  max-h-screen  container w-full py-16 md:py-12 flex-col' > {children}</aside>
